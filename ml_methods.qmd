...
core_ds_skills = [
    'has_python_programming_language', 'has_r_programming_language', 'has_statistics', 'has_data_analysis', 'has_big_data',
...
fig.update_layout(height=400, showlegend=False, template="plotly_white",
                  title_text="Core Model Results - Topic 2.5: ML/Data Science Skills Analysis")
fig.show()
```
