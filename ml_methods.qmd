...
## Heuristics employed for ML/DS roles
...
**Key Findings:**
- Some clusters show higher concentrations of ML/DS roles with corresponding higher average salaries
...
- Target skills that appear in higher-paying clusters to max
...
fig.update_layout(height=400, showlegend=False, template="plotly_white",
                  title_text="Core Model Results - ML/Data Science Skills Analysis\n")
fig.show()
```
