...
model_summary = pd.DataFrame({
    'Model': ['Multiple Linear Regression', 'Random Forest (Regression)', 'Random Forest (Classification)'],
...
models = ['Multiple Linear Regression', 'Random Forest Regression', 'Random Forest Classification']
